...
trait HooksTrait{
    ...
    public function enqueue_bootstrap_scripts(){
        $bootstrapCssAbs = WP_PLUGIN_DIR.Constants::BOOSTRAP_CSS_RELATIVE;
        $bootstrapJsAbs = WP_PLUGIN_DIR.Constants::BOOSTRAP_JS_RELATIVE;
        if(file_exists($bootstrapCssAbs) && file_exists($bootstrapJsAbs)){
            ...
            $bootstrapCss = plugins_url().Constants::BOOSTRAP_CSS_RELATIVE;
            $bootstrapJs = plugins_url().Constants::BOOSTRAP_JS_RELATIVE;
